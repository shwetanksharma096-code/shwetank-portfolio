...
export const FooterSection: React.FC<FooterSectionProps> = ({ data }) => {
  ...
  const facebookUrl = 'https://www.facebook.com/shwetank.sharma';
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-3 sm:gap-4 pt-2">
            ...
            <a
              ...
              className="w-13 h-13 rounded-full bg-[#1877F2] text-white flex items-center justify-center hover:bg-[#0d52ab] hover:scale-110 transition-all shadow-lg border border-black/10 group"
            >
              <svg className="w-6 h-6 fill-current group-hover:rotate-12 transition-transform duration-300" viewBox="0 0 24 24">
